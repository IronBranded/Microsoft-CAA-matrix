  ...
  forensicArtifacts: [
    {
      ...
      artifact: "Sign-ins for a service principal from an IP inconsistent with its expected hosting environment — the signature of credential reuse from attacker infrastructure",
    },
    {
