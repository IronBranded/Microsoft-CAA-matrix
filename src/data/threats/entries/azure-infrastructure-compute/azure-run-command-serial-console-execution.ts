  ...
  forensicArtifacts: [
    {
      ...
      artifact: 'Microsoft.Compute/virtualMachines/runCommand/action — the RBAC action for Run Command; appears regardless of which script was executed, so the operation itself is the primary signal',
    },
    {
