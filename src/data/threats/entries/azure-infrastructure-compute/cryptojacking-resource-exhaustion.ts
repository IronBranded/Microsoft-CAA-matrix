  ...
  forensicArtifacts: [
    {
      ...
      artifact: 'A burst of VM creation operations deploying many VMs in a short window, often GPU-optimized SKUs, from a caller with no prior history of provisioning at that scale',
    },
    {
