  ...
  forensicArtifacts: [
    {
      ...
      artifact:
        "ARM API calls authenticated via the VM's Managed Identity object ID, from IPs outside the expected Azure datacenter range, or against resources unrelated to the VM's normal function",
    },
    {
