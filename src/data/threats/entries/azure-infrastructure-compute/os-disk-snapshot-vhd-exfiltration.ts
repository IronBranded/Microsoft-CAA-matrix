...
const entry: ThreatEntry = {
  ...
  forensicArtifacts: [
    ...
    {
      source: 'AzureActivity',
      artifact: 'Generation of a SAS access grant against the snapshot (beginGetAccess) — the actual mechanism that makes a normally-inaccessible managed disk downloadable',
    },
    {
      source: 'AzureActivity',
