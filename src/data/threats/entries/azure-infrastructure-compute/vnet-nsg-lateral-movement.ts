  ...
  forensicArtifacts: [
    {
      ...
      artifact: "Internal east-west traffic between VMs/subnets that shouldn't have a legitimate reason to communicate directly, given an overly permissive any-to-any NSG rule",
    },
    {
