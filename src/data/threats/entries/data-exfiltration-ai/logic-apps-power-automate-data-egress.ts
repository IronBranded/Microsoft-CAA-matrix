  ...
  forensicArtifacts: [
    {
      ...
      artifact: 'Logic App creation/modification defining an HTTP action posting to an external, unfamiliar endpoint — the Azure-resource-side equivalent of a malicious Power Automate flow',
    },
    {
    ...
    {
      source: 'OfficeActivity (Power Automate)',
