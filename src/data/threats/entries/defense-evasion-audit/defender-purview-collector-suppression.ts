...
const entry: ThreatEntry = {
  ...
  forensicArtifacts: [
    ...
    },
    {
      ...
      artifact: 'Sensor/agent health status showing an unexpected offline or degraded state for specific hosts or connectors, rather than a broad platform-wide outage',
    },
    {
