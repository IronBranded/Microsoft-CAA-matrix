...
const entry: ThreatEntry = {
  ...
  forensicArtifacts: [
    ...
    {
      source: 'AzureActivity',
      artifact: "For Entra ID's own tenant-level diagnostic settings specifically — the configuration forwarding SigninLogs/AuditLogs into Sentinel — changes here are logged as a control-plane action distinct from the data-plane logs being forwarded, similar in spirit to the Unified Audit Log's own separate admin pipeline",
    },
    {
