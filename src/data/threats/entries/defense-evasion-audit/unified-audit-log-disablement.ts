...
const entry: ThreatEntry = {
  ...
  forensicArtifacts: [
    ...
    {
      source: 'Exchange Online PowerShell / Graph audit configuration API',
      artifact: 'Get-AdminAuditLogConfig showing UnifiedAuditLogIngestionEnabled: False when queried, if the attacker has not yet re-enabled it to cover their tracks',
    },
    {
...
| order by Timestamp desc`,
  ...
  runbook: {
    ...
    contain: [
      'Re-enable the Unified Audit Log immediately: `Set-AdminAuditLogConfig -UnifiedAuditLogIngestionEnabled $true`.',
