...
const entry: ThreatEntry = {
  ...
  atrm: [
    { id: 'AZT200', name: 'Phishing', tactic: 'Initial Access' },
    { id: 'AZT201.1', name: 'Valid Credentials: User Account', tactic: 'Initial Access' },
    { id: 'AZT504', name: 'Steal Application Access Token', tactic: 'Credential Access' },
  ],
