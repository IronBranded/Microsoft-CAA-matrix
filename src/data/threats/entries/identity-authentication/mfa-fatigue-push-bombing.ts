...
const entry: ThreatEntry = {
  ...
  forensicArtifacts: [
    ...
    },
    {
      ...
      artifact: 'Whether number matching was enabled and used correctly — a push approved without the correct number entered is a strong signal the approval was made carelessly',
    },
    {
