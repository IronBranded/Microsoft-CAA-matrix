...
const entry: ThreatEntry = {
  ...
  telemetry: {
    ...
    correlationMarkers: [
      ...
      'There is deliberately no relevantErrorCodes entry here: a validly-signed forged assertion is accepted by Entra ID exactly like a real one, producing no distinguishing AADSTS code — the SigninLogs/ADFSSignInLogs correlation gap above is the only reliable handle on this technique.',
    ],
  },
